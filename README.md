...
Ces données ont pour origine une recherche sur des étudiants dans deux écoles secondaires au Portugal en 2008. Il s'agit d'informations statistiques sur une grande variété d'attributs des étudiants. Ces données sont à l'origine utilisée pour effectuer une prédiction des notes des étudiants avec l'exploration de données. Elles sont aussi utiles pour des recherches sur
