...
> Pstatus - état de cohabitations des parents (binaire: 'T' - (together) ensemble ou 'A' - (apart) séparé)  
...
> Fedu - education du père (numérique: 0 - none, 1 - primary education (4th grade), 2 - 5th à 9th grade, 3 - secondary education ou 4 - higher education)  
